...
from agents.auxiliary.auxi_ver3_transfer import ImitationLearning
...
if __name__ == '__main__':
    ...
    argparser.add_argument(
        '-n', '--log_name',
        metavar='T',
        default='test_auxi_ver3_transfer',
    ...
    argparser.add_argument(
        ...
        default='/home/kimna/PytorchWorkspace/CARLA_Pytorch/carla_yaw/auxi_ver3/save_models_transfer/training/12_training.pth',
