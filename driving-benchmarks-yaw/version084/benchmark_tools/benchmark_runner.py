            ...
            for pose in experiment.poses[start_pose:]:
                for rep in range(start_rep, experiment.repetitions):
                    ...
                    time_out = experiment_suite.calculate_time_out(
                        self._get_shortest_path(positions[start_index], positions[end_index])) * 2 # kimna

                    print("time_out:", self._get_shortest_path(positions[start_index], positions[end_index]))
