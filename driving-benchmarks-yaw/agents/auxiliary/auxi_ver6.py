...
import agents.auxiliary.modules.auxi_net_v6 as resnet_carla

from version084.benchmark_tools.agent import Agent
from version084.carla.carla_server_pb2 import Control

from utils.auxi_ver6_adj import action_adjusting, action_adjusting_carla100
...
class ImitationLearning(Agent):
    ...
    def _compute_action(self, rgb_image, measurements, episode_name, direction=None):
        ...
        steer, acc, brake = action_adjusting(direction, steer, acc, brake, speed, pred_speed, episode_name, loc_x, loc_y, self.running_cnt, self.stopping_cnt)
