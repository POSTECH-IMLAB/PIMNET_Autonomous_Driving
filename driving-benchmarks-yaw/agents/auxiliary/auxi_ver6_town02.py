...
from utils.auxi_ver6_adj import action_adjusting, action_adjusting_carla100, action_adjusting_town02
...
class ImitationLearning(Agent):
    ...
    def _compute_action(self, rgb_image, measurements, episode_name, direction=None):
        ...
        ori_brake = brake
        ori_acc = acc
        steer, acc, brake = action_adjusting_town02(direction, steer, acc, brake, speed, pred_speed, episode_name, loc_x,
