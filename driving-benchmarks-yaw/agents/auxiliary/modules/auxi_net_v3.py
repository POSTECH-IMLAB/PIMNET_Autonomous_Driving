...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000):
        ...
        self.lateral_branch = nn.ModuleList([
            nn.Sequential(
                nn.Linear(512, 256),
                nn.ReLU(),
                nn.Dropout(0.5),
    ...
    def forward(self, x, speed):
        ...
        x_speed_posi =  x_speed_adp2 + x_posi_adp2_1
        ...
        x_steer_posi = x_steering_adp2 + x_posi_adp2_2
        ...
        return rela_pred_speed, pred_longi, pred_steering
